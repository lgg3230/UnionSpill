...
```bash
python3 .claude/scripts/generate_html_report.py peer-review \
...
```bash
python3 .claude/scripts/generate_html_report.py code-audit quality_reports/[file]_code_review.md
python3 .claude/scripts/generate_dashboard.py
```
...
Generate HTML version and refresh dashboard:
```bash
python3 .claude/scripts/generate_html_report.py strategy-review quality_reports/[file]_strategy_review.md
python3 .claude/scripts/generate_dashboard.py
```
...
- **Referees vary.** Different dispositions and pet peeves mean running `/paper-review --peer` twice gives different feedback -- just like submitting to two journals would.

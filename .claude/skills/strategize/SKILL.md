...
8. Generate HTML version and refresh dashboard:
   ```bash
   python3 .claude/scripts/generate_html_report.py strategy-review quality_reports/strategy_memo_[topic]_review.md
...
**Input:** `$ARGUMENTS` — research question, path to strategy memo, or path to existing UnionSpill-paper/draft.
...
**Existing UnionSpill-paper/draft:** [path or "not found"]
**Domain profile:** [loaded / not found]

...
Phase 4: Peer Review (depends on Phase 3)
  ├── /paper-review --all → Comprehensive Quality Score
  └── /paper-review --peer → domain-referee + methods-referee Reports
...
2. **Create the project folder structure** — `Data/`, `Data/`, `Programs/`, `UnionSpill-paper/`, `Graphs/`, `Tables/`, etc.

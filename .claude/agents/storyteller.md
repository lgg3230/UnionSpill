...
- Use the project theme at `UnionSpill-paper/quarto/custom.scss` — do NOT overwrite it
...
- **Beamer:** `UnionSpill-paper/talks/[format]_talk.tex`
- **Quarto:** `UnionSpill-paper/quarto/[format]_talk.qmd` + `UnionSpill-paper/quarto/custom.scss`

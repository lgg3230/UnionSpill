...
When invoked via `/paper-review [file.tex]` or `/paper-review --proofread`, run categories **4, 5, 6, 8 only** (writing quality + LaTeX + compilation + notation). No strategy alignment.

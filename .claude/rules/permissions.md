...
- **PRODUCES:** `Data/`, `Graphs/` (data visualization), data codebooks
- **CRITIC:** coder-critic
...
- **REQUIRES:** `quality_reports/strategy/{project}/strategy_memo.md` AND strategist-critic score >= 80
- **PRODUCES:** `Programs/`, `Tables/`, `Graphs/`, `quality_reports/results_summary.md`
- **CRITIC:** coder-critic
...
- **REQUIRES:** coder-critic score >= 80 AND `Tables/` contains `.tex` files
- **PRODUCES:** `UnionSpill-paper/Draft.tex`, `UnionSpill-paper/*.tex`, `quality_reports/claim_source_map_{project}.md`
...
- **PRODUCES:** `UnionSpill-paper/talks/` or `UnionSpill-paper/quarto/`

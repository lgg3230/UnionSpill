...
writeLines(tex_output, file.path("UnionSpill-paper/tables", "reg_main_specification.tex"))
```
...
3. **Decide:**
   ...
   - **Graduate to production** — copy to `R/`, `Programs/`; requires quality >= 80, tests pass, code clear. Move to `ARCHIVE/completed_[project]/`

...
- **INV-16:** absolute paths are pervasive in Stata via `$klc`-style globals (e.g.
  `Programs/rand_inference/4152_recentered_eventstudy.do:16-18`). This is an **explicitly documented
...
- **INV-15:** `Programs/conn_descriptives/4140_figure_conn_hist.py` — imports correctly at top (line 20+,

********************************************************************************
* treated_cba_similarity_pretreat_ref.do
*
...
*      (treated_cba_similarity_pretreat_ref_prep.py)
*   4. Merge similarity panel and run panel regressions
*
* Output:
*   Tables/cba_similarity/results_spill_treated_pretreat_ref_cba_similarity.csv
*   Tables/cba_similarity/results_spill_treated_pretreat_ref_ln_cba_similarity.csv
*   Tables/cba_similarity/treated_pretreat_ref_cba_similarity_table.tex
*   Tables/cba_similarity/treated_pretreat_ref_ln_cba_similarity_table.tex
********************************************************************************
...
log using "$logs/cba_similarity_log/treated_cba_similarity_pretreat_ref_`d'_`t'.log", replace text
...
shell ~/.conda/envs/venv_python312/bin/python "$programs/cba_similarity/treated_cba_similarity_pretreat_ref_prep.py"
...
merge m:1 identificad cba_period using "$rais_aux/treated_cba_similarity_pretreat_ref_panel.dta", ///
...
local spec              "treated_pretreat_ref_cba_similarity_tfpw_07_11"
...
capture erase "$tables/cba_similarity_log/results_spill_treated_pretreat_ref_cba_similarity.csv"
tempname fh
file open `fh' using "$tables/cba_similarity_log/results_spill_treated_pretreat_ref_cba_similarity.csv", write replace
file write `fh' "spec;section;outcome;row_type;value" _n
file close `fh'

capture erase "$tables/cba_similarity_log/results_spill_treated_pretreat_ref_ln_cba_similarity.csv"
tempname fh
file open `fh' using "$tables/cba_similarity_log/results_spill_treated_pretreat_ref_ln_cba_similarity.csv", write replace
file write `fh' "spec;section;outcome;row_type;value" _n
file close `fh'
...
local csv_spill "$tables/cba_similarity_log/results_spill_treated_pretreat_ref_cba_similarity.csv"
...
local spec_ln "treated_pretreat_ref_ln_cba_similarity_tfpw_07_11"
local csv_ln  "$tables/cba_similarity_log/results_spill_treated_pretreat_ref_ln_cba_similarity.csv"
...
* [log variant] raw-table generator disabled: shell ~/.conda/envs/venv_python312/bin/python "$programs/cba_similarity/generate_treated_pretreat_ref_similarity_latex.py"
shell ~/.conda/envs/venv_python312/bin/python "$programs/cba_similarity/generate_treated_pretreat_ref_ln_similarity_latex_log.py"

shell source "$programs/notify.sh" && notify "treated_cba_similarity_pretreat_ref done (log1p)" "Treated mirror pretreat-ref similarity regressions and tables complete"

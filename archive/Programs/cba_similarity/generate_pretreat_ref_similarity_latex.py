"""
generate_pretreat_ref_similarity_latex.py
MIRROR of generate_similarity_latex.py.

Reads results_spill_pretreat_ref_cba_similarity.csv and produces a LaTeX table
...
csv_path   = tables_dir / "results_spill_pretreat_ref_cba_similarity.csv"
tex_path   = tables_dir / "pretreat_ref_cba_similarity_table.tex"
...
base_spec  = "pretreat_ref_cba_similarity_tfpw_07_11"
union_spec = "pretreat_ref_cba_similarity_tfpw_07_11_union"
...
lines = [
    ...
    r"\label{tab:pretreat_ref_cba_similarity}",
    r"\scriptsize",
    ...
    (r"\scriptsize\textit{Notes:} This table reports spillover-effect estimates "
     ...
     r"orientation-corrected per-worker bilateral connectivity, averaged across "
     r"the four 2007--2011 year-pairs, with firm $i$'s own average employment as "
     r"denominator each year-pair. Only untreated firms with at least one "

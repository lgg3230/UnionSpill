********************************************************************************
* cba_similarity_pretreat_ref.do
*
...
*
* Output:
*   Tables/cba_similarity/results_spill_pretreat_ref_cba_similarity.csv
*   Tables/cba_similarity/results_spill_pretreat_ref_ln_cba_similarity.csv
*   Tables/cba_similarity/pretreat_ref_cba_similarity_table.tex
*   Tables/cba_similarity/pretreat_ref_ln_cba_similarity_table.tex
********************************************************************************
...
log using "$logs/cba_similarity_log/cba_similarity_pretreat_ref_`d'_`t'.log", replace text
...
* four similarity measures. Output: cba_similarity_pretreat_ref_panel.dta.
********************************************************************************

di as result "Running Python pretreat-ref similarity prep..."
shell ~/.conda/envs/venv_python312/bin/python "$programs/cba_similarity/cba_similarity_pretreat_ref_prep.py"
...
merge m:1 identificad cba_period using "$rais_aux/cba_similarity_pretreat_ref_panel.dta", ///
...
local spec             "pretreat_ref_cba_similarity_tfpw_07_11"
...
capture erase "$tables/cba_similarity_log/results_spill_pretreat_ref_cba_similarity.csv"
tempname fh
file open `fh' using "$tables/cba_similarity_log/results_spill_pretreat_ref_cba_similarity.csv", write replace
file write `fh' "spec;section;outcome;row_type;value" _n
file close `fh'

capture erase "$tables/cba_similarity_log/results_spill_pretreat_ref_ln_cba_similarity.csv"
tempname fh
file open `fh' using "$tables/cba_similarity_log/results_spill_pretreat_ref_ln_cba_similarity.csv", write replace
file write `fh' "spec;section;outcome;row_type;value" _n
file close `fh'
...
local csv_spill "$tables/cba_similarity_log/results_spill_pretreat_ref_cba_similarity.csv"
...
local spec_ln    "pretreat_ref_ln_cba_similarity_tfpw_07_11"
local csv_ln     "$tables/cba_similarity_log/results_spill_pretreat_ref_ln_cba_similarity.csv"
...
* [log variant] raw-table generator disabled: shell ~/.conda/envs/venv_python312/bin/python "$programs/cba_similarity/generate_pretreat_ref_similarity_latex.py"
di as result "LaTeX table written to Tables/cba_similarity/pretreat_ref_cba_similarity_table.tex"

shell ~/.conda/envs/venv_python312/bin/python "$programs/cba_similarity/generate_pretreat_ref_ln_similarity_latex_log.py"
di as result "LaTeX table written to Tables/cba_similarity/pretreat_ref_ln_cba_similarity_table.tex"

shell source "$programs/notify.sh" && notify "cba_similarity_pretreat_ref done (log1p)" "Pretreat-ref similarity regressions and tables complete"

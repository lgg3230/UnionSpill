...
log using "$logs/cba_similarity_log/treated_cba_similarity_pretreat_ref_uncorr_w_`d'_`t'.log", replace text
...
capture erase "$tables/cba_similarity_log/results_spill_treated_pretreat_ref_uncorr_w_cba_similarity.csv"
tempname fh
file open `fh' using "$tables/cba_similarity_log/results_spill_treated_pretreat_ref_uncorr_w_cba_similarity.csv", write replace
file write `fh' "spec;section;outcome;row_type;value" _n
file close `fh'

capture erase "$tables/cba_similarity_log/results_spill_treated_pretreat_ref_uncorr_w_ln_cba_similarity.csv"
tempname fh
file open `fh' using "$tables/cba_similarity_log/results_spill_treated_pretreat_ref_uncorr_w_ln_cba_similarity.csv", write replace
file write `fh' "spec;section;outcome;row_type;value" _n
file close `fh'
...
local csv_spill "$tables/cba_similarity_log/results_spill_treated_pretreat_ref_uncorr_w_cba_similarity.csv"
...
local csv_ln  "$tables/cba_similarity_log/results_spill_treated_pretreat_ref_uncorr_w_ln_cba_similarity.csv"
...
* [log variant] raw-table generator disabled: shell ~/.conda/envs/venv_python312/bin/python "$programs/cba_similarity/generate_treated_pretreat_ref_uncorr_w_similarity_latex.py"
shell ~/.conda/envs/venv_python312/bin/python "$programs/cba_similarity/generate_treated_pretreat_ref_uncorr_w_ln_similarity_latex_log.py"

shell source "$programs/notify.sh" && notify "treated_cba_similarity_pretreat_ref_uncorr_w done (log1p)" "Treated mirror pretreat-ref similarity regressions and tables complete"

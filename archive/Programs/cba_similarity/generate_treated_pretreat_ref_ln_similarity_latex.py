"""
generate_treated_pretreat_ref_ln_similarity_latex.py
MIRROR of generate_treated_ln_similarity_latex.py.

Reads results_spill_treated_pretreat_ref_ln_cba_similarity.csv and produces a
...
csv_path   = tables_dir / "results_spill_treated_pretreat_ref_ln_cba_similarity.csv"
tex_path   = tables_dir / "treated_pretreat_ref_ln_cba_similarity_table.tex"
...
base_spec  = "treated_pretreat_ref_ln_cba_similarity_tfpw_07_11"
union_spec = "treated_pretreat_ref_ln_cba_similarity_tfpw_07_11_union"
...
lines = [
    ...
    r"\label{tab:treated_pretreat_ref_ln_cba_similarity}",
    r"\scriptsize",
    ...
    (r"\textit{Notes:} This table reports treated-side reciprocal estimates "
     ...
     r"Table~\ref{tab:treated_pretreat_ref_cba_similarity}; see notes there. "

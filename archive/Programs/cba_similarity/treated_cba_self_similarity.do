...
log using "$logs/cba_similarity/treated_cba_self_similarity_`d'_`t'.log", replace text
...
capture erase "$tables/cba_similarity/results_spill_treated_self_cba_similarity.csv"
tempname fh
file open `fh' using "$tables/cba_similarity/results_spill_treated_self_cba_similarity.csv", write replace
file write `fh' "spec;section;outcome;row_type;value" _n
file close `fh'

capture erase "$tables/cba_similarity/results_spill_treated_self_ln_cba_similarity.csv"
tempname fh
file open `fh' using "$tables/cba_similarity/results_spill_treated_self_ln_cba_similarity.csv", write replace
file write `fh' "spec;section;outcome;row_type;value" _n
file close `fh'
...
local csv_spill "$tables/cba_similarity/results_spill_treated_self_cba_similarity.csv"
...
local csv_ln  "$tables/cba_similarity/results_spill_treated_self_ln_cba_similarity.csv"
...
shell ~/.conda/envs/venv_python312/bin/python "$programs/cba_similarity/generate_treated_self_similarity_latex.py"
shell ~/.conda/envs/venv_python312/bin/python "$programs/cba_similarity/generate_treated_self_ln_similarity_latex.py"

shell source "$programs/notify.sh" && notify "treated_cba_self_similarity done" "Treated self-similarity regressions and tables complete"

...
log using "$logs/cba_similarity/cba_similarity_avg_`d'_`t'.log", replace text
...
capture erase "$tables/cba_similarity/results_spill_cba_similarity_avg_tfpw_07_11.csv"
tempname fh
file open `fh' using "$tables/cba_similarity/results_spill_cba_similarity_avg_tfpw_07_11.csv", write replace
file write `fh' "spec;section;outcome;row_type;value" _n
file close `fh'

capture erase "$tables/cba_similarity/results_spill_ln_cba_similarity_avg_tfpw_07_11.csv"
tempname fh
file open `fh' using "$tables/cba_similarity/results_spill_ln_cba_similarity_avg_tfpw_07_11.csv", write replace
file write `fh' "spec;section;outcome;row_type;value" _n
file close `fh'
...
local csv_spill "$tables/cba_similarity/results_spill_cba_similarity_avg_tfpw_07_11.csv"
...
local csv_ln     "$tables/cba_similarity/results_spill_ln_cba_similarity_avg_tfpw_07_11.csv"
...
shell ~/.conda/envs/venv_python312/bin/python "$programs/cba_similarity/generate_similarity_avg_latex.py"
di as result "LaTeX table written to Tables/cba_similarity/cba_similarity_avg_table.tex"

shell ~/.conda/envs/venv_python312/bin/python "$programs/cba_similarity/generate_ln_similarity_avg_latex.py"
di as result "LaTeX table written to Tables/cba_similarity/ln_cba_similarity_avg_table.tex"

shell source "$programs/notify.sh" && notify "cba_similarity_avg done" "CBA similarity (avg treated ref) regressions and table complete"

#!/usr/bin/env python
"""
generate_cba_period_arms_latex.py

Four-arm comparison table for the CBA duplicate-row handling.

Reads : Tables/max_clause_row/cba_period_arms_comparison.csv   (written by Stata)
Writes: Tables/max_clause_row/cba_period_arms_comparison.tex
        Tables/max_clause_row/cba_period_arms_standalone.tex
...
csv_path = pipeline_dir / "cba_period_arms_comparison.csv"
tex_path = pipeline_dir / "cba_period_arms_comparison.tex"
standalone_path = pipeline_dir / "cba_period_arms_standalone.tex"
...
def build_table(w):
    header = [
        r"\begin{table}[H]",
        r"\centering",
        r"\caption{CBA Outcomes under Four Treatments of Duplicated Agreement Rows}",
        r"\label{tab:cba_period_arms}",
        r"\scriptsize",
...
\begin{document}
\pagestyle{empty}
\input{cba_period_arms_comparison.tex}
\end{document}
"""

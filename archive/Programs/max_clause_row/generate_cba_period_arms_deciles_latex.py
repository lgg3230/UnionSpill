#!/usr/bin/env python
"""
generate_cba_period_arms_deciles_latex.py

Four-arm comparison table with DECILE control bins.

Reads : Tables/max_clause_row/cba_period_arms_deciles_comparison.csv   (written by Stata)
Writes: Tables/max_clause_row/cba_period_arms_deciles_comparison.tex
        Tables/max_clause_row/cba_period_arms_deciles_standalone.tex
...
csv_path = pipeline_dir / "cba_period_arms_deciles_comparison.csv"
tex_path = pipeline_dir / "cba_period_arms_deciles_comparison.tex"
standalone_path = pipeline_dir / "cba_period_arms_deciles_standalone.tex"
...
def build_table(w):
    header = [
        r"\begin{table}[H]",
        r"\centering",
        r"\caption{CBA Outcomes under Four Treatments of Duplicated Agreement Rows, Decile Control Bins}",
        r"\label{tab:cba_period_arms_deciles}",
        r"\scriptsize",
    ...
    notes = (
        ...
        r"industry, microregion, and negotiation-month indicators and with decile bins "
        ...
        r"pre-treatment variable into ten groups on the 2009 balanced-panel cross-section "
...
\begin{document}
\pagestyle{empty}
\input{cba_period_arms_deciles_comparison.tex}
\end{document}
"""

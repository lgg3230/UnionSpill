"""
Assemble spillover table for the occ2c layer (upper_skill=mgr+high+bur / low_skill) (above-median firm employment).

Reads CSVs produced by 01e_layer_spillover_occ2c.do and outputs:
...
def build_latex() -> str:
    ...
    lines.append(
        r"\caption{Layer spillover effects --- occ2c (upper skill vs low skill)}"
    )
    lines.append(r"\label{tab:layer_specs_firm_occ2c}")
...
tex_out = TEX_TABLES / "table_layer_specs_firm_occ2c.tex"
csv_out = TABLES / "table_layer_specs_firm_occ2c.csv"

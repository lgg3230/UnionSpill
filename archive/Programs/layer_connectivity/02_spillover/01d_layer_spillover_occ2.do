...
*
* Layers:  occ2 (2-bin: high_skill / low_skill)
*
...
log using "$logs/layer_connectivity/02_spillover/layer_spillover_occ2_`d'_`t'.log", replace text
...
foreach layer in occ2 {
	...
	* ── Layer-balanced panel indicator ───────────────────────────────────────
	if "`layer'" == "occ2"   local layer_vals "high_skill low_skill"

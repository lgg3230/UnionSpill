#!/usr/bin/env python3
"""
Script 01d: Build per-worker transition records with demographic layer assignment.
...
Usage:
    python 01d_build_demog_transitions.py --layer gender
    python 01d_build_demog_transitions.py --layer race
"""

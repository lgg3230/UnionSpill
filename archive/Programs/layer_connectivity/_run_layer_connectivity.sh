...
SCRIPTS=/gpfs/kellogg/proj/lgg3230/UnionSpill/Programs/layer_connectivity/00_pipeline
...
$PYTHON "$SCRIPTS/00_cache_rais.py" --years 2007 2008 2>&1 | tee -a "$LOGS/00_cache.log"

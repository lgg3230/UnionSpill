...
*          simultaneously for edu2, gender, and race, without imposing the
*          layer-balanced-panel restriction.
*
* Outcomes (layer-level): lr_remdezr_layer, l_layer_emp
* Outcomes (firm-level):  lr_remdezr_w, l_firm_emp
*
* Output:  Tables/layer_connectivity/results_horse_race_binary.csv
********************************************************************************
...
log using "$logs/layer_connectivity/horse_race_binary_`d'_`t'.log", replace text
...
local csv_out "$tables/layer_connectivity/results_horse_race_binary.csv"
...
foreach layer in edu2 gender race {
	...
	foreach outcome in lr_remdezr_layer l_layer_emp {
		...
		foreach lv_o of local layer_vals {
			...
			file write `fh' `""horse_race_binary";"`layer'";"layer_firm_year";"`outcome_key'";"c_`lv1'_main";"'      %9.4f (`b_1_main')  `"`st_1_main'"' _n
			file write `fh' `""horse_race_binary";"`layer'";"layer_firm_year";"`outcome_key'";"c_`lv1'_main_se";"'   %9.4f (`se_1_main') `"""'             _n
			file write `fh' `""horse_race_binary";"`layer'";"layer_firm_year";"`outcome_key'";"c_`lv2'_main";"'      %9.4f (`b_2_main')  `"`st_2_main'"' _n
			file write `fh' `""horse_race_binary";"`layer'";"layer_firm_year";"`outcome_key'";"c_`lv2'_main_se";"'   %9.4f (`se_2_main') `"""'             _n
			file write `fh' `""horse_race_binary";"`layer'";"layer_firm_year";"`outcome_key'";"c_`lv1'_pre";"'       %9.4f (`b_1_pre')   `"`st_1_pre'"' _n
			file write `fh' `""horse_race_binary";"`layer'";"layer_firm_year";"`outcome_key'";"c_`lv1'_pre_se";"'    %9.4f (`se_1_pre')  `"""'            _n
			file write `fh' `""horse_race_binary";"`layer'";"layer_firm_year";"`outcome_key'";"c_`lv2'_pre";"'       %9.4f (`b_2_pre')   `"`st_2_pre'"' _n
			file write `fh' `""horse_race_binary";"`layer'";"layer_firm_year";"`outcome_key'";"c_`lv2'_pre_se";"'    %9.4f (`se_2_pre')  `"""'            _n
			file write `fh' `""horse_race_binary";"`layer'";"layer_firm_year";"`outcome_key'";"c_`lv1'_pre_ftest";"' %9.4f (`pf_1')      `"""'            _n
			file write `fh' `""horse_race_binary";"`layer'";"layer_firm_year";"`outcome_key'";"c_`lv2'_pre_ftest";"' %9.4f (`pf_2')      `"""'            _n
			file write `fh' `""horse_race_binary";"`layer'";"layer_firm_year";"`outcome_key'";"n_obs";"'             %12.0fc (`n_obs')   `"""'             _n
			file write `fh' `""horse_race_binary";"`layer'";"layer_firm_year";"`outcome_key'";"n_firms";"'           %12.0fc (`n_firms') `"""'             _n
			file close `fh'
		}
	}
	...
	preserve
		...
		collapse (first) c_`lv1' c_`lv2' treat_ultra in_balanced_panel ///
		...
		foreach outcome in lr_remdezr_w l_firm_emp {
			...
			tempname fh
			file open `fh' using "`csv_out'", write append
			file write `fh' `""horse_race_binary";"`layer'";"firm_firm_year";"`outcome'";"c_`lv1'_main";"'      %9.4f (`b_1_main')  `"`st_1_main'"' _n
			file write `fh' `""horse_race_binary";"`layer'";"firm_firm_year";"`outcome'";"c_`lv1'_main_se";"'   %9.4f (`se_1_main') `"""'             _n
			file write `fh' `""horse_race_binary";"`layer'";"firm_firm_year";"`outcome'";"c_`lv2'_main";"'      %9.4f (`b_2_main')  `"`st_2_main'"' _n
			file write `fh' `""horse_race_binary";"`layer'";"firm_firm_year";"`outcome'";"c_`lv2'_main_se";"'   %9.4f (`se_2_main') `"""'             _n
			file write `fh' `""horse_race_binary";"`layer'";"firm_firm_year";"`outcome'";"c_`lv1'_pre";"'       %9.4f (`b_1_pre')   `"`st_1_pre'"' _n
			file write `fh' `""horse_race_binary";"`layer'";"firm_firm_year";"`outcome'";"c_`lv1'_pre_se";"'    %9.4f (`se_1_pre')  `"""'            _n
			file write `fh' `""horse_race_binary";"`layer'";"firm_firm_year";"`outcome'";"c_`lv2'_pre";"'       %9.4f (`b_2_pre')   `"`st_2_pre'"' _n
			file write `fh' `""horse_race_binary";"`layer'";"firm_firm_year";"`outcome'";"c_`lv2'_pre_se";"'    %9.4f (`se_2_pre')  `"""'            _n
			file write `fh' `""horse_race_binary";"`layer'";"firm_firm_year";"`outcome'";"c_`lv1'_pre_ftest";"' %9.4f (`pf_1')      `"""'            _n
			file write `fh' `""horse_race_binary";"`layer'";"firm_firm_year";"`outcome'";"c_`lv2'_pre_ftest";"' %9.4f (`pf_2')      `"""'            _n
			file write `fh' `""horse_race_binary";"`layer'";"firm_firm_year";"`outcome'";"n_obs";"'             %12.0fc (`n_obs')   `"""'             _n
			file write `fh' `""horse_race_binary";"`layer'";"firm_firm_year";"`outcome'";"n_firms";"'           %12.0fc (`n_firms') `"""'             _n
			file close `fh'
		}
...
di as result "Horse race binary regressions complete. Results in `csv_out'"

log close

shell source /gpfs/kellogg/proj/lgg3230/UnionSpill/Programs/notify.sh && notify "Horse race binary done" "13f_horse_race_binary.do complete"

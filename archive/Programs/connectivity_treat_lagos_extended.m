...
%% Define the available years (EXTENDED: 2005-2011)
start_year = 2005;
end_year   = 2011;

%% Load Lagos Sample Dataset
% load dataset with dummy defining lagos sample
...
outputFile = '/kellogg/proj/lgg3230/UnionSpill/Data/RAIS_aux/connectivity_treat_2005_2011.csv';
writetable(finaltable,outputFile);

fprintf('Saved extended connectivity to %s\n', outputFile);
fprintf('Done!\n');

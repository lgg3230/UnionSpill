* Test: do ll_totalflows, ll_outflows, ll_inflows survive adding
* ib0.totalflows_pw_pre_07_114#i.year to absorb?
...
preserve
	...
	keep identificad year totalflows outflows inflows
	tempfile fp
	save `fp'
restore
...
foreach outcome in ll_totalflows ll_outflows ll_inflows {

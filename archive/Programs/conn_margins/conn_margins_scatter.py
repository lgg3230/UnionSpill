...
panels = [
    ("e_pre",  "Pre-treatment (2009\u20132011)", axes[0]),
    ("e_post", "Post-treatment (2012\u20132016)", axes[1]),
]
...
for y_col, title, ax in panels:
    ...
    ax.set_ylabel("Residualized log wages", fontsize=10)
...
out = graphs_dir / "scatter_resid_wages_vs_conn.pdf"
fig.savefig(out, bbox_inches="tight")
print(f"Saved: {out}")

out_png = graphs_dir / "scatter_resid_wages_vs_conn.png"

* Wrapper: set globals then run numb_clauses_winsor.do
set more off
set varabbrev off
...
do "$programs/numb_clauses_outliers/numb_clauses_winsor.do"

shell source /gpfs/kellogg/proj/lgg3230/UnionSpill/Programs/notify.sh && notify "numb_clauses_winsor done" "winsorization robustness check complete"

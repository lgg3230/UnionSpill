...
OUTPUT_FILE = "/Users/luisg/Library/CloudStorage/OneDrive-NorthwesternUniversity/4 - PhD/02_Research/Org_Econ BR/UnionSpillovers/Replication-Mar-2/UnionSpill/Programs/results/mega_tables_p0911_Oct25.xlsx"

csv_files = sorted(glob.glob(os.path.join(CSV_FOLDER, "*p0911_Oct25.csv")))

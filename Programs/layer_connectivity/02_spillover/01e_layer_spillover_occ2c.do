********************************************************************************
* UNION SPILLOVERS — LAYER-LEVEL SPILLOVER EFFECTS (OCC2 LAYER: HIGH-SKILL / LOW-SKILL)
...
*
* Layers:  occ2c (2-bin: upper_skill / low_skill)
*
...
log using "$logs/layer_connectivity/02_spillover/layer_spillover_occ2c_`d'_`t'.log", replace text
...
foreach layer in occ2c {
	...
	* ── Layer-balanced panel indicator ───────────────────────────────────────
	if "`layer'" == "occ2c"  local layer_vals "upper_skill low_skill"

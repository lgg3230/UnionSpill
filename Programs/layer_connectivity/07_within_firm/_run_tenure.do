********************************************************************************
* _run_tenure.do
* Tenure-only within-firm layer exhibits using current connectivity.
********************************************************************************
...
capture log close
log using "$logs/tenure_currentconn.log", replace text
di as result "== Tenure within-firm exhibits: current connectivity =="

...
* meanpre added 2026-08-01 (pre-treatment mean of the dependent variable on each
* column's estimation sample). Appended last so existing column positions in the
* exported CSVs are unchanged.
...
di as result "Wrote a7`table_suffix'.csv, a8`table_suffix'.csv, a6_group`table_suffix'.csv, a6_partition`table_suffix'.csv to $tables"

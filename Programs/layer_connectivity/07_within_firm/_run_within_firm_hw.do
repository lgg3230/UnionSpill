********************************************************************************
* _run_within_firm_hw.do
* Wrapper for hourly-wage within-firm layer exhibits (A6/A7/A8).
* Uses the current-connectivity overlay firm dataset and corrected layer outcomes.
********************************************************************************
...
capture log close
log using "$logs/within_firm_currentconn_hw.log", replace text
di as result "== Within-firm exhibits (A6/A7/A8): current connectivity, hourly wages =="

********************************************************************************
* _run_within_firm.do
* Wrapper for within-firm layer exhibits (A6/A7/A8).
* Uses the current-connectivity overlay firm dataset.
********************************************************************************
...
capture log close
log using "$logs/within_firm_currentconn.log", replace text
di as result "== Within-firm exhibits (A6/A7/A8): current connectivity =="
di as result "Started: `c(current_date)' `c(current_time)'"
do "$programs/01_within_firm_estimates.do"

...
*                                (LAYER-BALANCED PANEL + GEO/SECTOR FEs)
* Purpose: Horse race with layer-balanced panel sample and additional
*          microregion×year, mode_base_month×year, industry×year FEs.
*
* Outcomes (layer-level): lr_remdezr_layer, l_layer_emp
* Outcomes (firm-level):  lr_remdezr_w, l_firm_emp
*
* FE: firm×layer FE + year FE + microregion×year + base_month×year + industry×year
*
* Output:  Tables/layer_connectivity/results_horse_race_edu2_lbal_geo.csv
********************************************************************************
...
log using "$logs/layer_connectivity/horse_race_edu2_lbal_geo_`d'_`t'.log", replace text
...
local csv_out "$tables/layer_connectivity/results_horse_race_edu2_lbal_geo.csv"
...
* Additional FEs: microregion×year, mode_base_month×year, industry1×year
********************************************************************************
...
foreach outcome in lr_remdezr_layer l_layer_emp {
	...
	local extra "ib0.`outcome'_pre4#i.year ib0.l_layer_emp_pre4#i.year ib0.layer_totalflows_pw_pre4#i.year i.microregion#i.year i.mode_base_month#i.year i.industry1#i.year"
	...
	foreach lv_o in no_hs has_hs {
		...
		* ── Write to CSV ─────────────────────────────────────────────────────
		...
		file write `fh' `""horse_race_edu2_lbal_geo";"layer_firm_year";"`outcome_key'";"c_no_hs_main";"'    %9.4f (`b_no_hs_main')  `"`st_no_hs_main'"' _n
		file write `fh' `""horse_race_edu2_lbal_geo";"layer_firm_year";"`outcome_key'";"c_no_hs_main_se";"' %9.4f (`se_no_hs_main') `"""'              _n
		file write `fh' `""horse_race_edu2_lbal_geo";"layer_firm_year";"`outcome_key'";"c_has_hs_main";"'   %9.4f (`b_has_hs_main')  `"`st_has_hs_main'"' _n
		file write `fh' `""horse_race_edu2_lbal_geo";"layer_firm_year";"`outcome_key'";"c_has_hs_main_se";"'%9.4f (`se_has_hs_main') `"""'              _n
		file write `fh' `""horse_race_edu2_lbal_geo";"layer_firm_year";"`outcome_key'";"c_no_hs_pre";"'     %9.4f (`b_no_hs_pre')   `"`st_no_hs_pre'"' _n
		file write `fh' `""horse_race_edu2_lbal_geo";"layer_firm_year";"`outcome_key'";"c_no_hs_pre_se";"'  %9.4f (`se_no_hs_pre')  `"""'              _n
		file write `fh' `""horse_race_edu2_lbal_geo";"layer_firm_year";"`outcome_key'";"c_has_hs_pre";"'    %9.4f (`b_has_hs_pre')   `"`st_has_hs_pre'"' _n
		file write `fh' `""horse_race_edu2_lbal_geo";"layer_firm_year";"`outcome_key'";"c_has_hs_pre_se";"' %9.4f (`se_has_hs_pre')  `"""'              _n
		file write `fh' `""horse_race_edu2_lbal_geo";"layer_firm_year";"`outcome_key'";"c_no_hs_pre_ftest";"'  %9.4f (`pf_no_hs')   `"""'              _n
		file write `fh' `""horse_race_edu2_lbal_geo";"layer_firm_year";"`outcome_key'";"c_has_hs_pre_ftest";"' %9.4f (`pf_has_hs')  `"""'              _n
		file write `fh' `""horse_race_edu2_lbal_geo";"layer_firm_year";"`outcome_key'";"n_obs";"'           %12.0fc (`n_obs')    `"""'                  _n
		file write `fh' `""horse_race_edu2_lbal_geo";"layer_firm_year";"`outcome_key'";"n_firms";"'         %12.0fc (`n_firms')  `"""'                  _n
		file close `fh'
...
preserve
	...
	* Totalflows quartile bins
	...
	foreach outcome in lr_remdezr_w l_firm_emp {
		...
		local extra_f "ib0.`outcome'_pre4#i.year ib0.l_firm_emp_pre4#i.year ib0.totalflows_pw_pre4#i.year i.microregion#i.year i.mode_base_month#i.year i.industry1#i.year"
		...
		* ── Write to CSV ─────────────────────────────────────────────────────
		tempname fh
		file open  `fh' using "`csv_out'", write append
		file write `fh' `""horse_race_edu2_lbal_geo";"firm_firm_year";"`outcome'";"c_no_hs_main";"'    %9.4f (`b_no_hs_main')  `"`st_no_hs_main'"' _n
		file write `fh' `""horse_race_edu2_lbal_geo";"firm_firm_year";"`outcome'";"c_no_hs_main_se";"' %9.4f (`se_no_hs_main') `"""'              _n
		file write `fh' `""horse_race_edu2_lbal_geo";"firm_firm_year";"`outcome'";"c_has_hs_main";"'   %9.4f (`b_has_hs_main')  `"`st_has_hs_main'"' _n
		file write `fh' `""horse_race_edu2_lbal_geo";"firm_firm_year";"`outcome'";"c_has_hs_main_se";"'%9.4f (`se_has_hs_main') `"""'              _n
		file write `fh' `""horse_race_edu2_lbal_geo";"firm_firm_year";"`outcome'";"c_no_hs_pre";"'     %9.4f (`b_no_hs_pre')   `"`st_no_hs_pre'"' _n
		file write `fh' `""horse_race_edu2_lbal_geo";"firm_firm_year";"`outcome'";"c_no_hs_pre_se";"'  %9.4f (`se_no_hs_pre')  `"""'              _n
		file write `fh' `""horse_race_edu2_lbal_geo";"firm_firm_year";"`outcome'";"c_has_hs_pre";"'    %9.4f (`b_has_hs_pre')   `"`st_has_hs_pre'"' _n
		file write `fh' `""horse_race_edu2_lbal_geo";"firm_firm_year";"`outcome'";"c_has_hs_pre_se";"' %9.4f (`se_has_hs_pre')  `"""'              _n
		file write `fh' `""horse_race_edu2_lbal_geo";"firm_firm_year";"`outcome'";"c_no_hs_pre_ftest";"'  %9.4f (`pf_no_hs')   `"""'              _n
		file write `fh' `""horse_race_edu2_lbal_geo";"firm_firm_year";"`outcome'";"c_has_hs_pre_ftest";"' %9.4f (`pf_has_hs')  `"""'              _n
		file write `fh' `""horse_race_edu2_lbal_geo";"firm_firm_year";"`outcome'";"n_obs";"'           %12.0fc (`n_obs')    `"""'                  _n
		file write `fh' `""horse_race_edu2_lbal_geo";"firm_firm_year";"`outcome'";"n_firms";"'         %12.0fc (`n_firms')  `"""'                  _n
		file close `fh'
...
di as result "Horse race (layer-balanced + geo FEs) complete. Results in `csv_out'"

log close

shell source /gpfs/kellogg/proj/lgg3230/UnionSpill/Programs/notify.sh && notify "Horse race lbal_geo done" "13d_horse_race_edu2_lbal_geo.do complete"

...
TEX_TABLES_DIR = os.path.join(TABLES_DIR, "tex_tables")
...
ORDER = ["edu", "edu2", "gender", "race", "occ4"]
SUB_ORDER = {
    "edu":    ["0_no_hs", "1_hs", "2_higher"],
    "edu2":   ["no_hs", "has_hs"],
    "gender": ["female", "male"],
    "race":   ["nonwhite", "white"],
    "occ4":   ["1_mgr", "23_high", "4_bur", "5p_low"],
}
FORMAL_DEF = {
...
HEADER_LABEL = {
    ...
    ("race",   "white"):    "White",
    ("occ4",   "1_mgr"):    "Managers",
    ("occ4",   "23_high"):  r"\shortstack{High\\skill}",
    ("occ4",   "4_bur"):    r"\shortstack{Bur.\\lower}",
    ("occ4",   "5p_low"):   r"\shortstack{Low\\skill}",
}
...
tex_full = f"""%% Auto-generated by Programs/layer_connectivity/02_make_table.py
\\begin{{table}}[H]
  \\centering
...
tex_size = f"""%% Auto-generated by Programs/layer_connectivity/02_make_table.py
\\begin{{table}}[H]
  \\centering
...
# ---------------------------------------------------------------------------
out_full = os.path.join(TEX_TABLES_DIR, "layer_descriptives_full.tex")
out_size = os.path.join(TEX_TABLES_DIR, "layer_descriptives_size.tex")
...
tex_demog_full = f"""%% Auto-generated by Programs/layer_connectivity/02_make_table.py
\\begin{{table}}[H]
  \\centering
  \\caption{{Layer Connectivity Descriptives --- Full Spillover Sample}}
...
tex_demog_size = f"""%% Auto-generated by Programs/layer_connectivity/02_make_table.py
\\begin{{table}}[H]
  \\centering
  \\caption{{Layer Connectivity Descriptives --- By Firm Size}}
...
out_demog_full = os.path.join(TEX_TABLES_DIR, "layer_descriptives_demog_full.tex")
out_demog_size = os.path.join(TEX_TABLES_DIR, "layer_descriptives_demog_size.tex")

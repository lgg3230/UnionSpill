********************************************************************************
* UNION SPILLOVERS — HORSE RACE (CROSS-FIRM FE): c_no_hs vs c_has_hs simultaneously
* Purpose: Same as 13_horse_race_edu2.do but absorbs microregion×year,
*          industry×year, and mode×year FEs instead of firm FE.
*
* Outcomes (layer-level): lr_remdezr_layer, l_layer_emp
* Outcomes (firm-level):  lr_remdezr_w, l_firm_emp
*
* FE (layer-level): microregion×year + industry×year + mode×year + extra bins
* FE (firm-level):  microregion×year + industry×year + mode×year + extra bins
*
* Output:  Tables/layer_connectivity/results_horse_race_edu2_xfirm.csv
********************************************************************************
...
log using "$logs/layer_connectivity/horse_race_edu2_xfirm_`d'_`t'.log", replace text
...
* Firm×layer unit ID (used even in cross-firm spec for extra bin FEs)
...
local csv_out "$tables/layer_connectivity/results_horse_race_edu2_xfirm.csv"
...
********************************************************************************
* SECTION 5: LAYER-LEVEL REGRESSIONS (cross-firm FE, horse race)
********************************************************************************
...
foreach outcome in lr_remdezr_layer l_layer_emp {
	...
	foreach lv_o in no_hs has_hs {
		...
		* ── Write to CSV ─────────────────────────────────────────────────────
		...
		file write `fh' `""horse_race_edu2_xfirm";"layer_cross_firm";"`outcome_key'";"c_no_hs_main";"'    %9.4f (`b_no_hs_main')  `"`st_no_hs_main'"' _n
		file write `fh' `""horse_race_edu2_xfirm";"layer_cross_firm";"`outcome_key'";"c_no_hs_main_se";"' %9.4f (`se_no_hs_main') `"""'              _n
		file write `fh' `""horse_race_edu2_xfirm";"layer_cross_firm";"`outcome_key'";"c_has_hs_main";"'   %9.4f (`b_has_hs_main')  `"`st_has_hs_main'"' _n
		file write `fh' `""horse_race_edu2_xfirm";"layer_cross_firm";"`outcome_key'";"c_has_hs_main_se";"'%9.4f (`se_has_hs_main') `"""'              _n
		file write `fh' `""horse_race_edu2_xfirm";"layer_cross_firm";"`outcome_key'";"c_no_hs_pre";"'     %9.4f (`b_no_hs_pre')   `"`st_no_hs_pre'"' _n
		file write `fh' `""horse_race_edu2_xfirm";"layer_cross_firm";"`outcome_key'";"c_no_hs_pre_se";"'  %9.4f (`se_no_hs_pre')  `"""'              _n
		file write `fh' `""horse_race_edu2_xfirm";"layer_cross_firm";"`outcome_key'";"c_has_hs_pre";"'    %9.4f (`b_has_hs_pre')   `"`st_has_hs_pre'"' _n
		file write `fh' `""horse_race_edu2_xfirm";"layer_cross_firm";"`outcome_key'";"c_has_hs_pre_se";"' %9.4f (`se_has_hs_pre')  `"""'              _n
		file write `fh' `""horse_race_edu2_xfirm";"layer_cross_firm";"`outcome_key'";"c_no_hs_pre_ftest";"'  %9.4f (`pf_no_hs')   `"""'              _n
		file write `fh' `""horse_race_edu2_xfirm";"layer_cross_firm";"`outcome_key'";"c_has_hs_pre_ftest";"' %9.4f (`pf_has_hs')  `"""'              _n
		file write `fh' `""horse_race_edu2_xfirm";"layer_cross_firm";"`outcome_key'";"n_obs";"'           %12.0fc (`n_obs')    `"""'                  _n
		file write `fh' `""horse_race_edu2_xfirm";"layer_cross_firm";"`outcome_key'";"n_firms";"'         %12.0fc (`n_firms')  `"""'                  _n
		file close `fh'
...
********************************************************************************
* SECTION 6: FIRM-LEVEL REGRESSIONS (cross-firm FE, horse race)
********************************************************************************
	...
	* Totalflows quartile bins
	...
	foreach outcome in lr_remdezr_w l_firm_emp {
		...
		* ── Write to CSV ─────────────────────────────────────────────────────
		tempname fh
		file open  `fh' using "`csv_out'", write append
		file write `fh' `""horse_race_edu2_xfirm";"firm_cross_firm";"`outcome'";"c_no_hs_main";"'    %9.4f (`b_no_hs_main')  `"`st_no_hs_main'"' _n
		file write `fh' `""horse_race_edu2_xfirm";"firm_cross_firm";"`outcome'";"c_no_hs_main_se";"' %9.4f (`se_no_hs_main') `"""'              _n
		file write `fh' `""horse_race_edu2_xfirm";"firm_cross_firm";"`outcome'";"c_has_hs_main";"'   %9.4f (`b_has_hs_main')  `"`st_has_hs_main'"' _n
		file write `fh' `""horse_race_edu2_xfirm";"firm_cross_firm";"`outcome'";"c_has_hs_main_se";"'%9.4f (`se_has_hs_main') `"""'              _n
		file write `fh' `""horse_race_edu2_xfirm";"firm_cross_firm";"`outcome'";"c_no_hs_pre";"'     %9.4f (`b_no_hs_pre')   `"`st_no_hs_pre'"' _n
		file write `fh' `""horse_race_edu2_xfirm";"firm_cross_firm";"`outcome'";"c_no_hs_pre_se";"'  %9.4f (`se_no_hs_pre')  `"""'              _n
		file write `fh' `""horse_race_edu2_xfirm";"firm_cross_firm";"`outcome'";"c_has_hs_pre";"'    %9.4f (`b_has_hs_pre')   `"`st_has_hs_pre'"' _n
		file write `fh' `""horse_race_edu2_xfirm";"firm_cross_firm";"`outcome'";"c_has_hs_pre_se";"' %9.4f (`se_has_hs_pre')  `"""'              _n
		file write `fh' `""horse_race_edu2_xfirm";"firm_cross_firm";"`outcome'";"c_no_hs_pre_ftest";"'  %9.4f (`pf_no_hs')   `"""'              _n
		file write `fh' `""horse_race_edu2_xfirm";"firm_cross_firm";"`outcome'";"c_has_hs_pre_ftest";"' %9.4f (`pf_has_hs')  `"""'              _n
		file write `fh' `""horse_race_edu2_xfirm";"firm_cross_firm";"`outcome'";"n_obs";"'           %12.0fc (`n_obs')    `"""'                  _n
		file write `fh' `""horse_race_edu2_xfirm";"firm_cross_firm";"`outcome'";"n_firms";"'         %12.0fc (`n_firms')  `"""'                  _n
		file close `fh'
...
di as result "Horse race (cross-firm FE) complete. Results in `csv_out'"

log close

shell source /gpfs/kellogg/proj/lgg3230/UnionSpill/Programs/notify.sh && notify "Horse race xfirm done" "13b_horse_race_edu2_xfirm.do complete"

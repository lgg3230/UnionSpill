********************************************************************************
* UNION SPILLOVERS — DISENTANGLING LAYER-LEVEL SPILLOVER EFFECTS (OCC4)
* Purpose: Same as 11_disentangling_layers.do but for the occ4 layer:
*          CBO2002 first digit: 1=Bureaucrat-Managers, 2/3=Frontline-High Skills,
*          4=Bureaucrat-Lower level, 5+=Frontline-Low Skills.
*          Tests which layer's connectivity drives spillover effects.
*
...
*
* Output:  Tables/layer_connectivity/results_disentangle_occ4_layer_spill.csv
********************************************************************************
...
log using "$logs/layer_connectivity/03_disentangling/disentangling_occ4_`d'_`t'.log", replace text
...
********************************************************************************
* SECTION 1b: LOAD TOTALFLOWS WIDE CSV INTO TEMPFILE
********************************************************************************
...
count
	...
	****************************************************************************
	...
	preserve
		...
		* Build pre-treatment totalflows average
...
shell source /gpfs/kellogg/proj/lgg3230/UnionSpill/Programs/notify.sh && notify "Disentangling occ4 done" "01b_disentangle_occ4.do complete"

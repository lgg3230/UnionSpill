...
*
* New file (not an edit of Main_Results_micro_ind.do) per the house rule that a
* significant logic change gets its own script.
*
* Two changes relative to Main_Results_micro_ind.do:
*
...
********************************************************************************
* SECTION 1: DATA  (identical to Main_Results_micro_ind.do)
********************************************************************************
...
* ── Local exposure measures (levels, as in Main_Results_micro_ind.do) ────────
...
* Copied from Main_Results_micro_ind.do (lines 173-187). DECISION (2026-07-31):

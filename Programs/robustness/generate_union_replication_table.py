#!/usr/bin/env python3
"""
generate_union_replication_table.py
===================================
...
for tab:spill_union_controls in the main draft, and Main_Results_union_controls.do
...
Main_Results_union_controls.do run against the currentconn overlay):
...
Usage
-----
    python generate_union_replication_table.py                # no mean row
    python generate_union_replication_table.py --with-mean    # adds it
"""
...
def get(data, col, row_type, csv_name):
    try:
        ...
        raise SystemExit(
            ...
            "Re-run Main_Results_union_controls.do."
        )

...
OUTPUT_FILE = "/Users/luisg/Library/CloudStorage/OneDrive-NorthwesternUniversity/4 - PhD/02_Research/Org_Econ BR/UnionSpillovers/Replication-Mar-2/UnionSpill/Programs/results/mega_tables_p0911_A_2_ctf_aug6.xlsx"

csv_files = sorted(glob.glob(os.path.join(CSV_FOLDER, "MEGA_A*p0911_ctf.csv")))

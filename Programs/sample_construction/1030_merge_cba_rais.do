...
save "$rais_aux/one_cba_treat.dta", replace


export delimited "$rais_aux/one_cba_treat.csv", replace
restore
...
save "$rais_aux/zero_cba_treat.dta", replace


export delimited "$rais_aux/zero_cba_treat.csv", replace
restore

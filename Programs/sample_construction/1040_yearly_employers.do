...
if "$programs"   == "" global programs   "/kellogg/proj/lgg3230/UnionSpill/Programs/sample_construction"

foreach mscript in 1041_connectivity_full_lagos 1042_connectivity_treat_lagos ///
                   1043_connectivity_control_lagos 1044_connectivity_treat_onecba ///
                   1045_connectivity_treat_zerocba {
    di as result "[1040] MATLAB: `mscript'"
    shell UNIONSPILL_AUX="$rais_aux" "$matlab_exe" -nojvm < "$programs/sample_construction/`mscript'.m"
}
...
*
* the retired tier-C 3010_build_currentconn_ingredient.do applies the same rule on the overlay

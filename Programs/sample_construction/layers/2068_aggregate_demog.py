#!/usr/bin/env python3
"""
Script 2068: Aggregate demographic transition records to (firm, layer, year_pair) level.

Identical logic to 2067_aggregate.py; handles gender and race layers.

Usage:
    python 2068_aggregate_demog.py --layer gender
    python 2068_aggregate_demog.py --layer race
"""

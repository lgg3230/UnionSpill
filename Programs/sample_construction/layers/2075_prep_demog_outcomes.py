...
Mirrors archive/Programs/layer_connectivity/99_archive/06_prep_demog_outcomes.py but fills in zero-employment cells so that all
...
Key differences from archive/Programs/layer_connectivity/99_archive/06_prep_demog_outcomes.py:
...
Usage:
    python 2075_prep_demog_outcomes.py
    python 2075_prep_demog_outcomes.py --layer gender
    python 2075_prep_demog_outcomes.py --layer race
"""

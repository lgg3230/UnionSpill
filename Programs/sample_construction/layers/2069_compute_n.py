#!/usr/bin/env python3
"""
Script 2069: NaN-aware average across year pairs → final firm × layer dataset.

Replicates the _n logic from 1040_yearly_employers.do for each of:
  - ratio_total  → layer_treat_pw_n
  - ratio_same   → sametreat_pw_n
  - ratio_cross  → crosstreat_pw_n

Usage:
    python 2069_compute_n.py --layer occ3
    python 2069_compute_n.py --layer edu
"""

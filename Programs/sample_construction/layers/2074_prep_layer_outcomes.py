#!/usr/bin/env python3
"""
Script 2074: Build firm × layer × year outcomes (edu / edu2) with zero-employment cells.

Mirrors archive/Programs/layer_connectivity/99_archive/06_prep_layer_outcomes.py but fills in zero-employment cells so that all
...
Key differences from archive/Programs/layer_connectivity/99_archive/06_prep_layer_outcomes.py:
...
Usage:
    python 2074_prep_layer_outcomes.py
"""

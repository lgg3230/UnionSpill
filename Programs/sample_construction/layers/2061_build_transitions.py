#!/usr/bin/env python3
"""
Script 2061: Build per-worker transition records with layer assignment.
...
Usage:
    python 2061_build_transitions.py --layer occ3
    python 2061_build_transitions.py --layer edu
"""

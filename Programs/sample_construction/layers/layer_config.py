...
def _occ5_sara_pandas(s):
    ...
    Source: Programs/layer_connectivity/sara_files/archive/Programs/layer_connectivity/sara_files/000_clean_rais.do
...
# wage for that year. Series copied from Programs/1010_rais_clean.do:13, the same

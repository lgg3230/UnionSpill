...
are identical to 2093_permutation_engine.py.
"""
...
def broad_industry(b):
    """archive/Programs/results.do 18-category grouping of the 2-digit CNAE division."""
...
grp_pool = keys.broad.values[pool]                          # broad_industry (archive/Programs/results.do 18-cat)

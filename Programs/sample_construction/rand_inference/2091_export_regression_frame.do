...
* PROGRAM: 2091_export_regression_frame.do
* PURPOSE: Reproduce the EXACT pre-treatment construction + FE bins used by the
*          spillover spec (3012_pct_tfpw.do), export a clean
...
log using "$logs/2091_export_regression_frame_`d'.log", replace text
...
log close
shell source /gpfs/kellogg/proj/lgg3230/UnionSpill/Programs/notify.sh && notify "Stata done" "rand_inference 2091_export_regression_frame"

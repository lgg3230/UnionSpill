...
Usage
-----
    python 2083_residualize_fullrais.py --mode agetenure --min-obs 10
    python 2083_residualize_fullrais.py --mode agetenure --min-obs 10 --years 2011 \

...
*   stata-mp -b do Programs/residuals/2083_mincer_residuals.do
********************************************************************************
...
log using "$logs/2081_mincer_residuals_`d'_`t'.log", replace text
...
if _rc != 0 {
	...
	shell ~/.conda/envs/venv_python312/bin/python "$programs/2082_mincer_export.py"
...
* (3112_mincer.do reads the CSV and runs tostring...format(%014.0f))
...
********************************************************************************
* STEP 9 — Export CSV (same format as Python version; consumed by 3112_mincer.do)
********************************************************************************

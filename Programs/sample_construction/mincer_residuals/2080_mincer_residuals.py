"""
DEPRECATED — superseded by 2083_mincer_residuals.do (Stata/reghdfe).
...
2080_mincer_residuals.py
========================
Residualizes log December wages AND log hourly wages on worker characteristics
following Neri (Gui_coding/archive/Programs/Gui_coding/Residual_construction.R).

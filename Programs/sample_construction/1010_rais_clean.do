********************************************************************************
* PARALLEL PIPELINE -- combined tier-A clean
*
* Replaces 1010_rais_clean.do (this file) AND the retired 1060_rais_worker_panel.do with a single pass
* over raw RAIS, and additionally feeds 1050 so that raw RAIS is read ONCE rather
* than three times.
*
* WHY
*   1010 and 1060 were the same ~500-line script (REDUNDANCY_AUDIT R2). 1060
*   created 74 variables and kept 11, so its entire firm-level outcome block was
*   computed and discarded (R3). 1050 opened the raw files a third time and
*   re-implemented the same worker-spell selection (R1, R4).
*
* WHAT CHANGES
*   The clean, the deflation and the spell selection run once. The firm-level
...
*   intended difference from the repaired originals is that 2007-2008
*   worker_estab files now exist.
********************************************************************************

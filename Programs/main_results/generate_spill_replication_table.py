#!/usr/bin/env python3
"""
generate_spill_replication_table.py
===================================
...
Main_Results_pct_tfpw_07_11.do via _run_pct_tfpw_07_11_cc.do):
...
Usage
-----
    python generate_spill_replication_table.py                # no mean row
    python generate_spill_replication_table.py --with-mean    # adds it

--with-mean requires a "mean_pre" row_type in the CSV, which
Main_Results_pct_tfpw_07_11.do only emits after the step-3 edits. Without the

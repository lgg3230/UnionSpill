...
preserve
	...
	twoway (connected lr_remmedr year if treat_ultra==1, lcolor(sand) lwidth(medthick) ///
           ...
           ytitle("Log Average Earnings")  ///
		   xtitle("") ///
           legend(order(1 "Treated" 2 "Control") pos(6) row(1) region(lstyle(none))) ///
           title("Log Average Earnings Evolution by Treatment Status", size(medium large)) ///
           note("Vertical line indicates introduction of ultractivity (September 2012)") ///
		   graphregion( margin(medium) color(white))
...
reghdfe l_firm_emp treat_ultra##b(2011).year  if  lagos_sample_avg==1 & in_balanced_panel==1,  absorb( identificad industry1#year mode_base_month#year microregion#year) vce(cluster identificad)
...
reghdfe lr_remmedr treat_ultra##b(2011).year  if lagos_sample_avg==1 , absorb(year identificad industry1#year mode_base_month#year microregion#year ) vce(cluster identificad)
...
coefplot es_direct_remmedr, ///
	...
	ylabel(-.06(.02).08) ///
	ytitle("Dynamic DiD coefficients", size(small)) ///
    title("Direct Effect on Log Average Earnings", size(medium large)) ///
    note("Dashed line corresponds to the enactment of ultractivity (Sep. 2012)") ///
    graphregion(color(white)) bgcolor(white) ///
...
reghdfe lr_remdezr treat_ultra##b(2011).year  if lagos_sample_avg==1 & in_balanced_panel==1 , absorb(year identificad  industry1#year mode_base_month#year  microregion#year ) vce(cluster identificad)
estimates store es_direct_remdezr

// Create event study plot
coefplot es_direct_remdezr, ///
msymbol(diamond) ///
    keep(1.treat_ultra#2007.year 1.treat_ultra#2008.year 1.treat_ultra#2009.year 1.treat_ultra#2010.year 1.treat_ultra#2011.year 1.treat_ultra#2012.year 1.treat_ultra#2013.year 1.treat_ultra#2014.year 1.treat_ultra#2015.year 1.treat_ultra#2016.year) ///
...
reghdfe hiring treat_ultra##b(2011).year  if lagos_sample==1 & in_balanced_panel==1, absorb(year identificad  industry1#year mode_base_month#year microregion#year ) vce(cluster identificad)
estimates store es_direct_hiring

// Create event study plot
coefplot es_direct_hiring, ///
    keep(1.treat_ultra#2009.year 1.treat_ultra#2010.year 1.treat_ultra#2011.year 1.treat_ultra#2012.year 1.treat_ultra#2013.year 1.treat_ultra#2014.year 1.treat_ultra#2015.year 1.treat_ultra#2016.year) ///
    coeflabels(1.treat_ultra#2009.year = "2009" ///
              1.treat_ultra#2010.year = "2010" ///
              1.treat_ultra#2011.year = "2011" ///
	...
	ylabel(-.2(.05).3) ///
	ytitle("Dynamic DiD coefficients", size(small)) ///
    title("Direct Effect on Hiring", size(medium large)) ///
    note("Dashed line corresponds to the enactment of ultractivity (Sep. 2012)") ///
    graphregion(color(white)) bgcolor(white) ///
    ci(95) ciopts(recast(rcap) color(blue)) mcolor(blue)
	
graph export "$graphs/es_hiring_treat.png", as(png) replace

// I.d'. hiring rate according to lagos' definition:


reghdfe hiring_lagos treat_ultra##b(2011).year  if lagos_sample==1 & in_balanced_panel==1, absorb(year identificad  industry1#year mode_base_month#year microregion#year ) vce(cluster identificad)
estimates store es_direct_hiring
...
graph export "$graphs/es_hiringlagos_treat.png", as(png) replace


// I.e. retention rate:


reghdfe retention treat_ultra##b(2011).year  if lagos_sample==1 & in_balanced_panel==1, absorb(year identificad industry1#year mode_base_month#year microregion#year  ) vce(cluster identificad)
estimates store es_direct_retention

// Create event study plot
coefplot es_direct_retention, ///
    keep(1.treat_ultra#2009.year 1.treat_ultra#2010.year 1.treat_ultra#2011.year 1.treat_ultra#2012.year 1.treat_ultra#2013.year 1.treat_ultra#2014.year 1.treat_ultra#2015.year 1.treat_ultra#2016.year) ///
    coeflabels(1.treat_ultra#2009.year = "2009" ///
              1.treat_ultra#2010.year = "2010" ///
              1.treat_ultra#2011.year = "2011" ///
	...
	ylabel(-.06(.02).08) ///
	ytitle("Dynamic DiD coefficients", size(small)) ///
    title("Direct Effect on Retention", size(medium large)) ///
    note("Dashed line corresponds to the enactment of ultractivity (Sep. 2012)") ///
    graphregion(color(white)) bgcolor(white) ///
    ci(95) ciopts(recast(rcap) color(blue)) mcolor(blue)
	
graph export "$graphs/es_retention_treat.png", as(png) replace


// I.e'. retention rate:


reghdfe retention treat_ultra##b(2011).year  if lagos_sample_avg==1 & in_balanced_panel==1, absorb(year identificad industry1#year mode_base_month#year microregion#year  ) vce(cluster identificad)
estimates store es_direct_retention
...
coefplot es_direct_retention, ///
    ...
    note("Dashed line corresponds to the enactment of ultractivity (Sep. 2012)") ///
    graphregion(color(white)) bgcolor(white) ///
    text(-.03 6 "Post x Treat Coef: -.005", color(blue)) ///
    ci(95) ciopts(recast(rcap) color(blue)) mcolor(blue)
	
graph export "$graphs/es_retentionlagos_treat.png", as(png) replace

// I.f. Number of negotiations: does treatment leads to different rates of negotiations between treatment and control units?

reghdfe n_negs_union_year treat_ultra##b(2011).year  if in_balanced_panel==1 & lagos_sample_avg==1, absorb(year identificad industry1#year mode_base_month#year microregion#year) vce(cluster identificad)
estimates store es_direct_negs

coefplot es_direct_negs, ///
    keep(1.treat_ultra#2009.year 1.treat_ultra#2010.year 1.treat_ultra#2011.year 1.treat_ultra#2012.year 1.treat_ultra#2013.year 1.treat_ultra#2014.year 1.treat_ultra#2015.year 1.treat_ultra#2016.year) ///
    coeflabels(1.treat_ultra#2009.year = "2009" ///
              1.treat_ultra#2010.year = "2010" ///
              1.treat_ultra#2011.year = "2011" ///
	...
	ylabel(-.06(.02).08) ///
	ytitle("Dynamic DiD coefficients", size(small)) ///
    title("Direct Effect on Number of CBA Negotiations", size(large)) ///
    note("Dashed line corresponds to the enactment of ultractivity (Sep. 2012)") ///
    graphregion(color(white)) bgcolor(white) ///
    text(-.03 6 "Post x Treat Coef: -.005", color(red)) ///
...
// II. Lagos Sample without high connectivity controls:

// II.a. log employment

reghdfe l_firm_emp treat_ultra##b(2011).year  if  lagos_sample==1 & in_balanced_panel==1 & low_conn_control_ttpf==1,  absorb( identificad industry1#year mode_base_month#year microregion#year) vce(cluster identificad)
estimates store es_direct_emp_lowconn

reghdfe l_firm_emp treat_ultra##b(2011).treat_year  if  lagos_sample==1 & in_balanced_panel==1 & low_conn_control_ttpf==1,  absorb( identificad industry1#treat_year mode_base_month#treat_year microregion#treat_year) vce(cluster identificad)


// Create event study plot
coefplot es_direct_emp_lowconn, ///
    keep(1.treat_ultra#2009.year 1.treat_ultra#2010.year 1.treat_ultra#2011.year 1.treat_ultra#2012.year 1.treat_ultra#2013.year 1.treat_ultra#2014.year 1.treat_ultra#2015.year 1.treat_ultra#2016.year) ///
    coeflabels(1.treat_ultra#2009.year = "2009" ///
              1.treat_ultra#2010.year = "2010" ///
              1.treat_ultra#2011.year = "2011" ///
...
graph export "$graphs/es_l_emp_treat_lowconn.png", as(png) replace


// II.b. log december wages

reghdfe lr_remdezr treat_ultra##b(2011).year  if  lagos_sample==1 & in_balanced_panel==1 & low_conn_control_ttpf==1,  absorb( identificad industry1#year mode_base_month#year microregion#year) vce(cluster identificad)
estimates store es_direct_remdezr_lowconn

reghdfe lr_remdezr treat_ultra##treat_year  if  lagos_sample==1 & in_balanced_panel==1 & low_conn_control_ttpf==1,  absorb( identificad industry1#treat_year mode_base_month#treat_year microregion#treat_year) vce(cluster identificad)


// Create event study plot
coefplot es_direct_remdezr_lowconn, ///
    keep(1.treat_ultra#2009.year 1.treat_ultra#2010.year 1.treat_ultra#2011.year 1.treat_ultra#2012.year 1.treat_ultra#2013.year 1.treat_ultra#2014.year 1.treat_ultra#2015.year 1.treat_ultra#2016.year) ///
    msymbol(diamond) ///
    coeflabels(1.treat_ultra#2009.year = "2009" ///
              1.treat_ultra#2010.year = "2010" ///
    ...
    title("Direct Effect on Log-Employment", size(medium large)) ///
    note("Dashed line corresponds to the enactment of ultractivity (Sep. 2012)") ///
    text(-.03 6 "Post x Treat Coef: .024", color(blue)) ///
    graphregion(color(white)) bgcolor(white) ///
    ci(95) ciopts(recast(rcap) color(blue)) mcolor(blue)
	
graph export "$graphs/es_remdezr_treat_lowconn.png", as(png) replace


**# Bookmark #1
// II. Doing DiD tables:

// tempfile results_es_direct
eststo clear

eststo: qui reghdfe l_firm_emp treat_ultra##i.treat_year if lagos_sample==1 & in_balanced_panel==1, absorb(year identificad industry1#year mode_base_month#year microregion#year) vce(cluster identificad)
// estimates store did_direct_emp

eststo: qui reghdfe lr_remdezr treat_ultra##i.treat_year if lagos_sample==1 & in_balanced_panel==1, absorb(year identificad industry1#year mode_base_month#year microregion#year) vce(cluster identificad)
// estimates store did_direct_remdezr

eststo: qui reghdfe lr_remmedr treat_ultra##i.treat_year if lagos_sample==1 & in_balanced_panel==1, absorb(year identificad industry1#treat_year mode_base_month#treat_year microregion#treat_year) vce(cluster identificad)
// estimates store did_direct_remmedr


gen pre_treat_year = cond(year<2012, 1,0)

reghdfe lr_remdezr treat_ultra##i.treat_year if lagos_sample==1 & in_balanced_panel==1, absorb(year identificad industry1#treat_year mode_base_month#treat_year microregion#treat_year) vce(cluster identificad)

esttab using "$tables/direct_did.csv" ,     /// only the interaction terms
...
// II Direct Effects: Sample 1: Using all estabs with at least one cba negotiated
	
// II.a. log employment

reghdfe l_firm_emp treat_ultra##b(2011).year  if   in_balanced_panel==1,  absorb( identificad industry1#year mode_base_month#year microregion#year) vce(cluster identificad)
estimates store es_direct_emp_1cba

reghdfe l_firm_emp treat_ultra##treat_year  if   in_balanced_panel==1,  absorb( identificad industry1#treat_year mode_base_month#treat_year microregion#treat_year) vce(cluster identificad)

// Create event study plot
coefplot es_direct_emp_1cba, ///
    keep(1.treat_ultra#2009.year 1.treat_ultra#2010.year 1.treat_ultra#2011.year 1.treat_ultra#2012.year 1.treat_ultra#2013.year 1.treat_ultra#2014.year 1.treat_ultra#2015.year 1.treat_ultra#2016.year) ///
    coeflabels(1.treat_ultra#2009.year = "2009" ///
              1.treat_ultra#2010.year = "2010" ///
              1.treat_ultra#2011.year = "2011" ///
    ...
    title("Direct Effect on Log-Employment", size(medium large)) ///
    note("Dashed line corresponds to the enactment of ultractivity (Sep. 2012)") ///
    text(-.05 6 "Post x Tre5at Coef: -.025", color(orange)) ///
    graphregion(color(white)) bgcolor(white) ///
    ci(95) ciopts(recast(rcap) color(orange)) mcolor(orange)
	
graph export "$graphs/es_l_emp_treat_1cba.png", as(png) replace


// II.b. log December wages

reghdfe lr_remdezr treat_ultra##b(2011).year  if   in_balanced_panel==1,  absorb( identificad industry1#year mode_base_month#year microregion#year) vce(cluster identificad)
estimates store es_direct_remdezr_1cba


reghdfe lr_remdezr treat_ultra##treat_year  if   in_balanced_panel==1,  absorb( identificad industry1#treat_year mode_base_month#treat_year microregion#treat_year) vce(cluster identificad)

// Create event study plot
coefplot es_direct_remdezr_1cba, ///
    keep(1.treat_ultra#2009.year 1.treat_ultra#2010.year 1.treat_ultra#2011.year 1.treat_ultra#2012.year 1.treat_ultra#2013.year 1.treat_ultra#2014.year 1.treat_ultra#2015.year 1.treat_ultra#2016.year) ///
    coeflabels(1.treat_ultra#2009.year = "2009" ///
              1.treat_ultra#2010.year = "2010" ///
              1.treat_ultra#2011.year = "2011" ///
	...
	ylabel(-.06(.02).08) ///
	ytitle("Dynamic DiD coefficients", size(small)) ///
    title("Direct Effect on Log-Dec Earnings", size(medium large)) ///
    note("Dashed line corresponds to the enactment of ultractivity (Sep. 2012)") ///
    text(-.03 6 "Post x Treat Coef: -.005", color(blue)) ///
    graphregion(color(white)) bgcolor(white) ///
    ci(95) ciopts(recast(rcap) color(blue)) mcolor(blue)
	
graph export "$graphs/es_remdezr_treat_1cba.png", as(png) replace


// II.a.1 Excluding high connectivity estabs from control

// II.a. log employment

reghdfe l_firm_emp treat_ultra##treat_year  if   in_balanced_panel==1 & low_conn_control_ttpf==1,  absorb( identificad industry1#treat_year mode_base_month#treat_year microregion#treat_year) vce(cluster identificad)

reghdfe l_firm_emp treat_ultra##b(2011).year  if   in_balanced_panel==1 & low_conn_control_ttpf==1,  absorb( identificad industry1#year mode_base_month#year microregion#year) vce(cluster identificad)
estimates store es_direct_emp_1cba
...
coefplot es_direct_emp_1cba, ///
    ...
    title("Direct Effect on Log-Employment", size(medium large)) ///
    note("Dashed line corresponds to the enactment of ultractivity (Sep. 2012)") ///
    text(-.05 6 "Post x Treat Coef: -.02", color(orange)) ///
    graphregion(color(white)) bgcolor(white) ///
    ci(95) ciopts(recast(rcap) color(orange)) mcolor(orange)
	
graph export "$graphs/es_l_emp_treat_1cba_lowconn.png", as(png) replace


// II.b. log December wages

reghdfe lr_remdezr treat_ultra##treat_year  if   in_balanced_panel==1 & low_conn_control_ttpf==1,  absorb( identificad industry1#treat_year mode_base_month#treat_year microregion#treat_year) vce(cluster identificad)

reghdfe lr_remdezr treat_ultra##b(2011).year  if   in_balanced_panel==1 & low_conn_control_ttpf==1,  absorb( identificad industry1#year mode_base_month#year microregion#year) vce(cluster identificad)
estimates store es_direct_remdezr_1cba
...
coefplot es_direct_remdezr_1cba, ///
    ...
    title("Direct Effect on Log-Dec Earnings", size(medium large)) ///
    note("Dashed line corresponds to the enactment of ultractivity (Sep. 2012)") ///
    text(-.03 6 "Post x Treat Coef: -.006", color(blue)) ///
    graphregion(color(white)) bgcolor(white) ///
    ci(95) ciopts(recast(rcap) color(blue)) mcolor(blue)
	
graph export "$graphs/es_remdezr_treat_1cba_lowconn.png", as(png) replace



// III Direct Effects: Sample 1.1: Using all estabs with at least one cba negotiated, but excluding high connectivity
	
// III.a. log employment

reghdfe l_firm_emp treat_ultra##b(2011).year  if   in_balanced_panel==1 & high_totaltreat_pf==0,  absorb( identificad industry1#year mode_base_month#year microregion#year) vce(cluster identificad)
estimates store es_direct_emp_1cba
...
coefplot es_direct_remdezr_1cba, ///
    ...
    title("Direct Effect on Log-Dec Earnings", size(medium large)) ///
    note("Dashed line corresponds to the enactment of ultractivity (Sep. 2012)") ///
    text(-.03 6 "Post x Treat Coef: 0.005", color(blue)) ///
    graphregion(color(white)) bgcolor(white) ///
    ci(95) ciopts(recast(rcap) color(blue)) mcolor(blue)
...
// III Using all in a balanced panel
	
// III.a. log employment

reghdfe l_firm_emp treat_ultra##b(2011).year  if   in_balanced_panel==1,  absorb( identificad industry1#year  microregion#year) vce(cluster identificad)
estimates store es_direct_emp_all

reghdfe l_firm_emp treat_ultra##treat_year  if   in_balanced_panel==1,  absorb( identificad industry1#treat_year microregion#treat_year) vce(cluster identificad)


// Create event study plot
coefplot es_direct_emp_all, ///
    keep(1.treat_ultra#2009.year 1.treat_ultra#2010.year 1.treat_ultra#2011.year 1.treat_ultra#2012.year 1.treat_ultra#2013.year 1.treat_ultra#2014.year 1.treat_ultra#2015.year 1.treat_ultra#2016.year) ///
    coeflabels(1.treat_ultra#2009.year = "2009" ///
              1.treat_ultra#2010.year = "2010"  ///
              1.treat_ultra#2011.year = "2011"  ///
    ...
    title("Direct Effect on Log-Employment", size(medium large)) ///
    note("Dashed line corresponds to the enactment of ultractivity (Sep. 2012)") ///
    text(-.04 5 "Post x Treat Coef: -0.017", color(orange)) ///
    graphregion(color(white)) bgcolor(white) ///
    ci(95) ciopts(recast(rcap) color(orange)) mcolor(orange)
	
graph export "$graphs/es_l_emp_treat_all.png", as(png) replace


// III.b. log December wages

reghdfe lr_remdezr treat_ultra##b(2011).year  if   in_balanced_panel==1,  absorb( identificad industry1#year mode_base_month#year microregion#year) vce(cluster identificad)
estimates store es_direct_remdezr_all


reghdfe lr_remdezr treat_ultra##treat_year  if   in_balanced_panel==1,  absorb( identificad industry1#treat_year microregion#treat_year) vce(cluster identificad)

// Create event study plot
coefplot es_direct_remdezr_all, ///
    keep(1.treat_ultra#2009.year 1.treat_ultra#2010.year 1.treat_ultra#2011.year 1.treat_ultra#2012.year 1.treat_ultra#2013.year 1.treat_ultra#2014.year 1.treat_ultra#2015.year 1.treat_ultra#2016.year) ///
    coeflabels(1.treat_ultra#2009.year = "2009" ///
              1.treat_ultra#2010.year = "2010" ///
              1.treat_ultra#2011.year = "2011" ///
...
graph export "$graphs/es_remdezr_treat_all.png", as(png) replace


// All establishments, appart from high connectivity in the control

// III.a. log employment



reghdfe l_firm_emp treat_ultra##treat_year  if   in_balanced_panel==1 & low_conn_control_ttpf==1,  absorb( identificad industry1#treat_year microregion#treat_year) vce(cluster identificad)


reghdfe l_firm_emp treat_ultra##b(2011).year  if   in_balanced_panel==1 & low_conn_control_ttpf==1,  absorb( identificad industry1#year  microregion#year) vce(cluster identificad)
estimates store es_direct_emp_all
...
coefplot es_direct_emp_all, ///
    ...
    title("Direct Effect on Log-Employment", size(medium large)) ///
    note("Dashed line corresponds to the enactment of ultractivity (Sep. 2012)") ///
    text(-.04 5 "Post x Treat Coef: .022", color(orange)) ///
    graphregion(color(white)) bgcolor(white) ///
    ci(95) ciopts(recast(rcap) color(orange)) mcolor(orange)
	
graph export "$graphs/es_l_emp_treat_all_lowconn.png", as(png) replace


// III.b. log December wages


reghdfe lr_remdezr treat_ultra##treat_year  if   in_balanced_panel==1 & low_conn_control_ttpf==1,  absorb( identificad industry1#treat_year microregion#treat_year) vce(cluster identificad)
...
coefplot es_direct_remdezr_all, ///
    ...
    title("Direct Effect on Log-Dec Earnings", size(medium large)) ///
    note("Dashed line corresponds to the enactment of ultractivity (Sep. 2012)") ///
    text(-.03 6 "Post x Treat Coef: -.023", color(blue)) ///
    graphregion(color(white)) bgcolor(white) ///
    ci(95) ciopts(recast(rcap) color(blue)) mcolor(blue)
	
graph export "$graphs/es_remdezr_treat_all_lowconn.png", as(png) replace

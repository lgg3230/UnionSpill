...
if (`05_flows'          ==1) do "$programs/05_yearly_employers.do";
if (`results'           ==1) do "$programs/results.do"
if (`results_clauses'   ==1) do "$programs/results_clauses.do"

...
log using "$logs/max_clause_row/cba_period_arms_`d'_`t'.log", replace text
...
use `pf_data', clear
export delimited using "$tables/max_clause_row/cba_period_arms_comparison.csv", replace
...
shell source /gpfs/kellogg/proj/lgg3230/UnionSpill/Programs/notify.sh && notify "cba_period_arms done" "four arms: v1_all, v1_max, v1_mean, v2"

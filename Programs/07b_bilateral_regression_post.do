...
* AUTHOR: LUIS GOMES
* PROGRAM: BILATERAL CONNECTIVITY REGRESSION - POST-TREATMENT (2011-2015)
* INPUT: bilateral_connectivity_2011_2016.csv, bilateral_connectivity_2007_2011.csv
* OUTPUT: Regression coefficients CSV for Python coefplot (pre + post)
* NOTE: Uses 4 year pairs (like pre-treatment): 2011-12, 2012-13, 2013-14, 2014-15
********************************************************************************

* This script follows the same structure as 06_bilateral_regression.do
* but for post-treatment bilateral flows, and ALSO includes pre-treatment
* bilateral flows as a regressor to compare their predictive power
...
********************************************************************************
* STEP 8: RUN REGRESSIONS AND STORE COEFFICIENTS
********************************************************************************

di _newline(2) "=== Running regressions ==="

* Create file to store coefficients for Python
tempname coef_hold
tempfile coef_data
postfile `coef_hold' str50 variable str20 var_type coef se ci_lower ci_upper str30 spec str15 reg_type r2 using `coef_data'
...
* ============================================================================
* UNIVARIATE REGRESSIONS: Post-treatment bilateral connectivity
* Each predictor in a separate regression with establishment i FE
* ============================================================================

di _newline "=== Univariate regressions: Post-treatment bilateral connectivity ==="
...
foreach var of local proximity_vars {
    ...
    if _rc == 0 {
        ...
        qui reghdfe z_bilateral_conn_post `var', absorb(identificad_i) vce(robust)
        ...
        post `coef_hold' ("`var'") ("proximity") (`coef') (`se') (`ci_lower') (`ci_upper') ("post") ("univariate") (`r2')
    }
    else {
...
foreach var of local dummy_vars {
    ...
    post `coef_hold' ("`var'") ("dummy") (`coef') (`se') (`ci_lower') (`ci_upper') ("post") ("univariate") (`r2')
}

* Pre-treatment bilateral connectivity (univariate)
di "  Regressing on z_bilateral_conn_pre..."
qui reghdfe z_bilateral_conn_post z_bilateral_conn_pre, absorb(identificad_i) vce(robust)

local coef = _b[z_bilateral_conn_pre]
local se = _se[z_bilateral_conn_pre]
local ci_lower = `coef' - 1.96 * `se'
local ci_upper = `coef' + 1.96 * `se'
local r2 = e(r2)

post `coef_hold' ("z_bilateral_conn_pre") ("pre_connectivity") (`coef') (`se') (`ci_lower') (`ci_upper') ("post") ("univariate") (`r2')

* ============================================================================
* MULTIVARIATE REGRESSION: Post-treatment (all predictors, no pre control)
* ============================================================================

di _newline "=== Multivariate regression: Post-treatment (without pre control) ==="
...
* Store R-squared for this specification
local r2_post_multi = e(r2)
...
foreach var of local proximity_vars {
    ...
    local ci_lower = `coef' - 1.96 * `se'
    local ci_upper = `coef' + 1.96 * `se'
    post `coef_hold' ("`var'") ("proximity") (`coef') (`se') (`ci_lower') (`ci_upper') ("post") ("multivariate") (`r2_post_multi')
}
...
foreach var of local dummy_vars {
    ...
    local ci_lower = `coef' - 1.96 * `se'
    local ci_upper = `coef' + 1.96 * `se'
    post `coef_hold' ("`var'") ("dummy") (`coef') (`se') (`ci_lower') (`ci_upper') ("post") ("multivariate") (`r2_post_multi')
}

* ============================================================================
* MULTIVARIATE REGRESSION: Post-treatment (with pre control)
* Shows what ADDITIONALLY predicts post-treatment flows beyond pre-treatment
* ============================================================================

di _newline "=== Multivariate regression: Post-treatment (with pre control) ==="
...
estimates store reg_post_with_pre

* Store R-squared for this specification
local r2_post_with_pre = e(r2)
...
local ci_lower = `coef' - 1.96 * `se'
local ci_upper = `coef' + 1.96 * `se'
post `coef_hold' ("z_bilateral_conn_pre") ("pre_connectivity") (`coef') (`se') (`ci_lower') (`ci_upper') ("post_with_pre") ("multivariate") (`r2_post_with_pre')
...
foreach var of local proximity_vars {
    ...
    local ci_lower = `coef' - 1.96 * `se'
    local ci_upper = `coef' + 1.96 * `se'
    post `coef_hold' ("`var'") ("proximity") (`coef') (`se') (`ci_lower') (`ci_upper') ("post_with_pre") ("multivariate") (`r2_post_with_pre')
}
...
foreach var of local dummy_vars {
    ...
    local ci_lower = `coef' - 1.96 * `se'
    local ci_upper = `coef' + 1.96 * `se'
    post `coef_hold' ("`var'") ("dummy") (`coef') (`se') (`ci_lower') (`ci_upper') ("post_with_pre") ("multivariate") (`r2_post_with_pre')
}

* ============================================================================
* UNIVARIATE REGRESSIONS: Pre-treatment bilateral connectivity (for reference)
* ============================================================================

di _newline "=== Univariate regressions: Pre-treatment bilateral connectivity ==="
...
foreach var of local proximity_vars {
    ...
    if _rc == 0 {
        di "  Regressing on `var'..."
        qui reghdfe z_bilateral_conn_pre `var', absorb(identificad_i) vce(robust)
        ...
        post `coef_hold' ("`var'") ("proximity") (`coef') (`se') (`ci_lower') (`ci_upper') ("pre") ("univariate") (`r2')
    }
    else {
        di "  Skipping `var' (variable not found)"
    }
...
foreach var of local dummy_vars {
    ...
    post `coef_hold' ("`var'") ("dummy") (`coef') (`se') (`ci_lower') (`ci_upper') ("pre") ("univariate") (`r2')
}

* ============================================================================
* MULTIVARIATE REGRESSION: Pre-treatment (for comparison table)
* ============================================================================

di _newline "=== Multivariate regression: Pre-treatment ==="

reghdfe z_bilateral_conn_pre ///
    z_geo_proximity z_size_proximity z_wage_proximity ///
    z_female_proximity z_nonwhite_proximity z_educ_proximity ///
    z_hs_proximity z_nhs_proximity ///
    same_muni same_microregion same_union same_industry same_industry_micro, ///
...
foreach var of local proximity_vars {
    ...
    local ci_lower = `coef' - 1.96 * `se'
    local ci_upper = `coef' + 1.96 * `se'
    post `coef_hold' ("`var'") ("proximity") (`coef') (`se') (`ci_lower') (`ci_upper') ("pre") ("multivariate") (`r2_pre_multi')
}
...
foreach var of local dummy_vars {
    ...
    local ci_lower = `coef' - 1.96 * `se'
    local ci_upper = `coef' + 1.96 * `se'
    post `coef_hold' ("`var'") ("dummy") (`coef') (`se') (`ci_lower') (`ci_upper') ("pre") ("multivariate") (`r2_pre_multi')
}

postclose `coef_hold'

********************************************************************************
* STEP 9: EXPORT COEFFICIENTS TO CSV FOR PYTHON
********************************************************************************

preserve
use `coef_data', clear
export delimited using "$rais_aux/bilateral_regression_coefficients_post.csv", replace
di _newline "Saved: $rais_aux/bilateral_regression_coefficients_post.csv"
restore

********************************************************************************
* STEP 10: EXPORT REGRESSION TABLE (MULTIVARIATE)
********************************************************************************

esttab reg_pre_multi reg_post_multi reg_post_with_pre using "$tables/bilateral_regression_pre_post.tex", ///
    replace booktabs label ///
    b(3) se(3) star(* 0.10 ** 0.05 *** 0.01) ///
    title("Bilateral Connectivity: Pre vs Post Treatment (Multivariate)") ///
    mtitles("Pre (2007-2011)" "Post (2011-2015)" "Post + Pre Control") ///
    stats(N r2, labels("Observations" "R-squared") fmt(%12.0fc %9.3f)) ///
    addnotes("Robust standard errors. Establishment i fixed effects absorbed." ///
             "Pre-treatment: 4 year-pairs 2007-2011. Post-treatment: 4 year-pairs 2011-2015." ///
             "Firm characteristics based on 2009-2011 pre-treatment averages.")

di "Saved: $tables/bilateral_regression_pre_post.tex"
...
di _newline(2) "===== BILATERAL REGRESSION (POST-TREATMENT) COMPLETE ====="
di _newline "Output files:"
di "  - $rais_aux/bilateral_regression_coefficients_post.csv"
di "  - $tables/bilateral_regression_pre_post.tex"
di _newline "Regressions run:"
di "  - Univariate: each predictor separately (proximity + dummies + pre-connectivity)"
di "  - Multivariate: all predictors together (with and without pre-connectivity control)"
di _newline "Run Python script for coefficient plots:"
di "  python Programs/07b_bilateral_coefplot_post.py"

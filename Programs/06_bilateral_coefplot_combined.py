...
GRAVITY_MULTI_FILE = RAIS_AUX / "bilateral_pretreat_gravity_coefficients_multivariate.csv"

# 07d regression: predicting late-pre connectivity with early connectivity + gravity (split files)
PRETREAT_UNIV_FILE = RAIS_AUX / "bilateral_pretreatment_coefficients_univariate.csv"
PRETREAT_MULTI_FILE = RAIS_AUX / "bilateral_pretreatment_coefficients_multivariate.csv"

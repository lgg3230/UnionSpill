...
Why a new script rather than an edit to 4180_table_union_controls_latex.py:
that script builds a SIX-column table from the legacy Tables/robustness/ path
for tab:spill_union_controls in the main draft, and 3072_union_controls.do
...
Usage
-----
    python 4050_table_union.py                # no mean row
    python 4050_table_union.py --with-mean    # adds it
"""

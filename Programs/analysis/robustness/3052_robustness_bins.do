...
preserve
	* See the note in 3012_pct_tfpw.do: the $rais_aux copy is a
	* 47-byte header-only stub, the real file is under $rais_firm. churn_u and
	* churn_rate_u are unused below, so no published number was affected.

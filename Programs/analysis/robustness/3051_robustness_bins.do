* Wrapper: robustness bins, CURRENT-CONNECTIVITY panel.
*
* Created 2026-08-01. Tables/currentconn_full/robustness/ already held this
* script's output, but the only committed wrapper (_run_robustness.do) points
...
do "$programs/analysis/robustness/3052_robustness_bins.do"

...
*          extra pre-treatment control (same spec as 3082_turnover.do).
...
*          Variables verified in 1010_rais_clean.do collapse block.
...
* Variables available in the DTA (confirmed from 1010_rais_clean.do collapse):

...
4210_table_turnover_latex.py and archive/Programs/composition/generate_composition_latex.py build a different
...
Usage
-----
    python 4030_table_twopanel.py                 # both, no mean
    python 4030_table_twopanel.py --with-mean     # both, with mean
    python 4030_table_twopanel.py --only turnover
"""

...
deliberate guard: these files are the paper's figures.
    ...
    python 5010_copy_figures_to_paper.py            # report what would change
    python 5010_copy_figures_to_paper.py --apply    # actually copy
...
# which is how the event studies work -- 3012_pct_tfpw.do stamps

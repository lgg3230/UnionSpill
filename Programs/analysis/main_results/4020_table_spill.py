...
3012_pct_tfpw.do via 3011_pct_tfpw.do):
...
Usage
-----
    python 4020_table_spill.py                # no mean row
    python 4020_table_spill.py --with-mean    # adds it

--with-mean requires a "mean_pre" row_type in the CSV, which
3012_pct_tfpw.do only emits after the step-3 edits. Without the

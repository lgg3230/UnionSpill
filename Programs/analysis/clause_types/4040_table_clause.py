...
Seven columns drawn from TWO pipelines:
    (1)-(3) clause-type counts   -- 3032_clause_types.do
    (4)-(6) clause-type shares   -- 3032_clause_types.do
    (7)     wage-equivalent value -- cba_value/3042_cba_value.do
...
Usage
-----
    python 4040_table_clause.py                # no mean row
    python 4040_table_clause.py --with-mean    # adds it
"""

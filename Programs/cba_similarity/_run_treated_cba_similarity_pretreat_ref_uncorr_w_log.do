* Wrapper: set globals then run treated_cba_similarity_pretreat_ref_uncorr_w_log.do
set more off
set varabbrev off
...
do "$programs/cba_similarity/treated_cba_similarity_pretreat_ref_uncorr_w_log.do"

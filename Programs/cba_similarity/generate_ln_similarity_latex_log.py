...
base_spec  = "ln_cba_similarity_tfpw_07_11"
union_spec = "ln_cba_similarity_tfpw_07_11_union"
...
lines = [
    ...
    (r"\scriptsize\textit{Notes:} This table reports spillover-effect estimates of "
     ...
     r"each similarity measure; the outcome is $\ln(1+\text{similarity})$, so zero-similarity observations are retained. "

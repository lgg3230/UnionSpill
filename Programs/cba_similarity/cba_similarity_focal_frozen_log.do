...
log using "$logs/cba_similarity_log/cba_similarity_focal_frozen_`d'_`t'.log", replace text
...
capture erase "$tables/cba_similarity_log/results_spill_focal_frozen_cba_similarity.csv"
tempname fh
file open `fh' using "$tables/cba_similarity_log/results_spill_focal_frozen_cba_similarity.csv", write replace
file write `fh' "spec;section;outcome;row_type;value" _n
file close `fh'

capture erase "$tables/cba_similarity_log/results_spill_focal_frozen_ln_cba_similarity.csv"
tempname fh
file open `fh' using "$tables/cba_similarity_log/results_spill_focal_frozen_ln_cba_similarity.csv", write replace
file write `fh' "spec;section;outcome;row_type;value" _n
file close `fh'
...
local csv_spill "$tables/cba_similarity_log/results_spill_focal_frozen_cba_similarity.csv"
...
local csv_ln     "$tables/cba_similarity_log/results_spill_focal_frozen_ln_cba_similarity.csv"
...
* [log variant] raw-table generator disabled: shell ~/.conda/envs/venv_python312/bin/python "$programs/cba_similarity/generate_focal_frozen_similarity_latex.py"
di as result "LaTeX table written to Tables/cba_similarity/focal_frozen_cba_similarity_table.tex"

shell ~/.conda/envs/venv_python312/bin/python "$programs/cba_similarity/generate_focal_frozen_ln_similarity_latex_log.py"
di as result "LaTeX table written to Tables/cba_similarity/focal_frozen_ln_cba_similarity_table.tex"

shell source "$programs/notify.sh" && notify "cba_similarity_focal_frozen done (log1p)" "Focal-frozen similarity regressions and tables complete"

* Wrapper: set globals then run cba_similarity_decomp_avg.do
*
* Self-contained: exports cba_clauses_by_period.dta from the source firm panel,
* then runs the Python avg-decomp prep. No upstream similarity panel needed.
...
do "$programs/cba_similarity/cba_similarity_decomp_avg.do"

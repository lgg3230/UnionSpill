...
Reads results_spill_cba_similarity_tfpw_07_11.csv and produces a LaTeX table
...
csv_path   = tables_dir / "results_spill_cba_similarity_tfpw_07_11.csv"
tex_path   = tables_dir / "cba_similarity_table.tex"
...
lines = [
    r"\begin{table}[H]",
    r"\centering",
    r"\caption{CBA Content Similarity and Connectivity: Bilateral Flow-Weighted Reference}",
    r"\scriptsize",
    ...
    (r"\scriptsize\textit{Notes:} This table reports spillover-effect estimates of "
     ...
     r"vector and a \emph{flow-weighted average} of the clause vectors of treated "

...
log using "$logs/clause_types/cba_similarity_avg_pos_conn_`d'_`t'.log", replace text
...
label var jaccard         "Jaccard similarity to avg treated CBA"
...
local csv "$tables/clause_types/results_spill_cba_similarity_avg_pos_conn.csv"
capture erase "`csv'"
tempname fh
...
shell ~/.conda/envs/venv_python312/bin/python "$programs/clause_types/generate_similarity_avg_pos_conn_latex.py"

...
*   Tables/clause_types/results_spill_cba_similarity_avg_tfpw_07_11.csv
*   Tables/clause_types/cba_similarity_avg_table.tex
********************************************************************************
...
log using "$logs/clause_types/cba_similarity_avg_`d'_`t'.log", replace text
...
shell ~/.conda/envs/venv_python312/bin/python "$programs/clause_types/cba_similarity_avg_prep.py"
...
capture erase "$tables/clause_types/results_spill_cba_similarity_avg_tfpw_07_11.csv"
tempname fh
file open `fh' using "$tables/clause_types/results_spill_cba_similarity_avg_tfpw_07_11.csv", write replace
file write `fh' "spec;section;outcome;row_type;value" _n
file close `fh'

capture erase "$tables/clause_types/results_spill_ln_cba_similarity_avg_tfpw_07_11.csv"
tempname fh
file open `fh' using "$tables/clause_types/results_spill_ln_cba_similarity_avg_tfpw_07_11.csv", write replace
file write `fh' "spec;section;outcome;row_type;value" _n
file close `fh'
...
shell ~/.conda/envs/venv_python312/bin/python "$programs/clause_types/generate_similarity_avg_latex.py"
di as result "LaTeX table written to Tables/clause_types/cba_similarity_avg_table.tex"

shell ~/.conda/envs/venv_python312/bin/python "$programs/clause_types/generate_ln_similarity_avg_latex.py"
di as result "LaTeX table written to Tables/clause_types/ln_cba_similarity_avg_table.tex"

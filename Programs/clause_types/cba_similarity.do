...
*
* Similarity measures: cosine, bray_curtis, total_variation, jaccard
...
*
* Output:
*   Tables/clause_types/results_direct_panel[A/B/C]_cba_similarity_tfpw_07_11.csv
*   Tables/clause_types/results_spill_cba_similarity_tfpw_07_11.csv
*   Tables/clause_types/cba_similarity_table.tex
********************************************************************************
...
log using "$logs/clause_types/cba_similarity_`d'_`t'.log", replace text
...
* Output: Data/RAIS_aux/cba_similarity_panel.dta
********************************************************************************

di as result "Running Python similarity prep..."
shell ~/.conda/envs/venv_python312/bin/python "$programs/clause_types/cba_similarity_prep.py"
...
label var jaccard         "Jaccard similarity to connected treated avg"

local sim_outcomes "cosine bray_curtis total_variation jaccard"
...
local ln_sim_outcomes "ln_cosine ln_bray_curtis ln_total_variation ln_jaccard"
...
capture erase "$tables/clause_types/results_spill_cba_similarity_tfpw_07_11.csv"
tempname fh
file open `fh' using "$tables/clause_types/results_spill_cba_similarity_tfpw_07_11.csv", write replace
file write `fh' "spec;section;outcome;row_type;value" _n
file close `fh'

capture erase "$tables/clause_types/results_spill_ln_cba_similarity_tfpw_07_11.csv"
tempname fh
file open `fh' using "$tables/clause_types/results_spill_ln_cba_similarity_tfpw_07_11.csv", write replace
file write `fh' "spec;section;outcome;row_type;value" _n
file close `fh'
...
local csv_spill "$tables/clause_types/results_spill_cba_similarity_tfpw_07_11.csv"
...
local spec_ln    "ln_cba_similarity_tfpw_07_11"
local csv_ln     "$tables/clause_types/results_spill_ln_cba_similarity_tfpw_07_11.csv"
...
shell ~/.conda/envs/venv_python312/bin/python "$programs/clause_types/generate_similarity_latex.py"
di as result "LaTeX table written to Tables/clause_types/cba_similarity_table.tex"

shell ~/.conda/envs/venv_python312/bin/python "$programs/clause_types/generate_ln_similarity_latex.py"
di as result "LaTeX table written to Tables/clause_types/ln_cba_similarity_table.tex"

shell source "$programs/notify.sh" && notify "cba_similarity done" "CBA similarity regressions and table complete"

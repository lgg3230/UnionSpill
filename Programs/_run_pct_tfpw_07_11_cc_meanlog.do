* Wrapper: MEAN-OF-LOG size-control variant (see _meanlog.do).
* Wrapper: set globals then run Main_Results_pct_tfpw_07_11_meanlog.do (cluster,
...
global tables    "$main/UnionSpill/Tables/pct_tfpw_cc_meanlog"
global graphs    "$main/UnionSpill/Graphs/pct_tfpw_cc_meanlog"
global logs      "$main/UnionSpill/Logs/pct_tfpw_cc_meanlog"
global programs  "$main/UnionSpill/Programs"

do "$programs/Main_Results_pct_tfpw_07_11_meanlog.do"
shell source /gpfs/kellogg/proj/lgg3230/UnionSpill/Programs/notify.sh && notify "pct_tfpw_cc_meanlog" "mean-of-log size-control variant finished"
